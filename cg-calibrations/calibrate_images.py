...
for path in svg_paths:
    for suffix in (''):
        ...
        img.cam.write(os.path.join('images-test', ids['basename'] + suffix + '.json'),
        ...
        img.set_plot_limits()
        matplotlib.pyplot.savefig(os.path.join('images-test', ids['basename'] + suffix + '-markup.jpg'), dpi=dpi)
